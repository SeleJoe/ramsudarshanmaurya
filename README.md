...
- Under "Assets," find the Windows installer file. It may have a name like `ramsudarshanmaurya-setup-v1.0.exe`.
...
- `Examples/` – Sample projects for STM32 and ESP32 boards
- `Libs/` – Libraries used for FreeRTOS, MQTT, BLE, and LoRaWAN
- `Docs/` – Manuals and tutorial PDFs
- `Tools/` – Flashing and debugging tools
- `README.md` – Basic information and quick start tips
